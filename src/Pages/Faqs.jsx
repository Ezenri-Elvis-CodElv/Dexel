...
import { FaCloud, FaLock, FaCreditCard, FaRegQuestionCircle, FaHandsHelping } from "react-icons/fa";

const faqs = [
    {
        question: "What is Gryndle?",
        shortAnswer: "Gryndle is a cloud-native payment processing platform for secure, scalable, and efficient payments.",
        details: [
    ...
    },
    {
        ...
        shortAnswer: "Yes, Gryndle uses industry-standard encryption and is certified under the highest security standards.",
        details: [
    ...
    },
    {
        ...
        shortAnswer: "Our support team is available 24/7 via contact form or email.",
        details: [
                        ...
                        >
                            ...
                            <span
                                className={`transition-transform duration-300 ml-2 ${
                                    openIdx === idx ? "rotate-180 text-[#14B8A6]" : "rotate-0 text-[#F59E42]"
                                }`}
                            >
